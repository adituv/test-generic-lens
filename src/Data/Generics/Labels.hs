-- Copied verbatim (other than the addition of this comment) from the master
-- branch of lens-generic on github.  This module is temporarily required
-- until a future release of lens-generic that includes this module.
